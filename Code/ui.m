...
function citation(imp_fig)
    citation = strcat(('\textbf{This code is free to use for research purposes, please cite the following papers:} $$\\$$'),...
    ('Diercks, M.-L., Mildon, Z. K., Boulton, S. J., Hussain, E., Al\c ci\c cek, C.,'),...
    ('Y\i ld\i r\i m, C., \& Aykut, T. (2023). Constraining historical earthquake'),...   
    (' sequences with Coulomb stress models: An example from western Türkiye.'),...
    (' Journal of Geophysical Research: Solid Earth, 128, e2023JB026627.$$\\$$'),...
